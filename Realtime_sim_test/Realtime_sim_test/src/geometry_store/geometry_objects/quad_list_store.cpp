...
void quad_list_store::init(geom_parameters* geom_param_ptr)
{
	...
	quad_shader.create_shader((shadersPath.string() + "/resources/shaders/dynmesh_vert_shader.vert").c_str(),
		(shadersPath.string() + "/resources/shaders/dynmesh_frag_shader.frag").c_str());
